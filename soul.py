...
TOKEN = '7450223569:AAHq5WYeEckIbiMjnMMtYVdQ8k1HlgzgRKg'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002369473756
CHANNEL_ID = -1002369473756
error_channel_id = -1002369473756
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin selected @GOKU_OWNER*", parse_mode='Markdown')
    else:
